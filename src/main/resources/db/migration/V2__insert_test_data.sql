...
-- Тестові користувачі
INSERT INTO users (keycloak_id, email, first_name, last_name, user_type, phone) VALUES
    ('test-vulnerable-keycloak-id', 'vulnerable@test.com', 'Марія', 'Іваненко', 'AFFECTED_PERSON', '+380671234567'),
    ('test-volunteer-keycloak-id', 'volunteer@test.com', 'Олексій', 'Петренко', 'VOLUNTEER', '+380679876543'),
    ('test-volunteer2-keycloak-id', 'volunteer2@test.com', 'Анна', 'Сидоренко', 'VOLUNTEER', '+380665555555');
